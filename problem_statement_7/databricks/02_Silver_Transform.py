...
# MAGIC Use NVIDIA NIM (Llama-3.1-70b) to extract structured entities from raw documents
...
bill_of_sale_purchase|bill_of_sale_sale|cdl|insurance|maintenance_invoice|irp_card|certificate_of_title|ifta_return|form_2290|lease_agreement|unknown"""
